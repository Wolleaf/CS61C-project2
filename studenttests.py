...
class TestAbsLoss(TestCase):
    ...
    def test_absloss_invalid_array(self):
        t = AssemblyTest(self, "../coverage-src/abs_loss.s")
        array0 = t.array([])
        array1 = t.array([])
        array2 = t.array([])
...
class TestSquaredLoss(TestCase):
    ...
    # Add other test cases if neccesary
    def test_squaredloss_invalid_array(self):
        t = AssemblyTest(self, "../coverage-src/squared_loss.s")
        array0 = t.array([])
        array1 = t.array([])
        array2 = t.array([])
...
class TestZeroOneLoss(TestCase):
    ...
    # Add other test cases if neccesary
    def test_zerooneloss_invalid_array(self):
        t = AssemblyTest(self, "../coverage-src/zero_one_loss.s")
        array0 = t.array([])
        array1 = t.array([])
        array2 = t.array([])
...
class TestInitializeZero(TestCase):
    ...
    # Add other test cases if neccesary
    def test_initializezero_invalid_size(self):
        t = AssemblyTest(self, "../coverage-src/initialize_zero.s")
        t.input_scalar("a0", -1)
        t.call("initialize_zero")
        t.execute(36)

    def test_initializezero_malloc_error(self):
        t = AssemblyTest(self, "../coverage-src/initialize_zero.s")
        t.input_scalar("a0", 2000000000)
        t.call("initialize_zero")
        t.execute(26)
